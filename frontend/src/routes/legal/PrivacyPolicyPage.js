    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <p className="mt-8">
            <strong className="font-semibold text-gray-900">Data Retention.</strong> If using an account, we store your data until your transfer is deleted, or your account deleted. You can request data deletion by sending an email to {process.env.REACT_APP_SUPPORT_EMAIL}.
          </p>
          <p className="mt-8">
          ...
          <p className="mt-8">
            <strong className="font-semibold text-gray-900">User Rights.</strong> You have the right to access, modify, or delete your data. To exercise these rights, you can delete your account via the account page or send a request to {process.env.REACT_APP_SUPPORT_EMAIL} for data deletion and related inquiries.
          </p>
          <p className="mt-8">
