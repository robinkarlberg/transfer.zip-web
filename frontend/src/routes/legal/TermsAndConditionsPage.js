      ...
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <div className="mt-8">
            ...
            <p>To request a refund, please contact us at {process.env.REACT_APP_SUPPORT_EMAIL} with your account details and the reason for your refund request. We will review your request and respond within 7 business days. Approved refunds will be processed within 14 business days of approval.</p>
          </div>
          ...
          <p className="mt-8">
            <strong className="font-semibold text-gray-900">Contact Information.</strong> For any questions or concerns regarding these terms and conditions, please contact us at {process.env.REACT_APP_SUPPORT_EMAIL}.

            To report DMCA violations, please contact us at {process.env.REACT_APP_CONTACT_EMAIL}.
          </p>
