      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            {process.env.REACT_APP_DISCORD_URL && <a href={process.env.REACT_APP_DISCORD_URL} className="text-gray-500 hover:text-gray-900 --dark:hover:text-white ms-5">
            ...
            {process.env.REACT_APP_TWITTER_URL && <a href={process.env.REACT_APP_TWITTER_URL} className="text-gray-500 hover:text-gray-900 --dark:hover:text-white ms-5">
            ...
            {process.env.REACT_APP_GITHUB_URL && <a href={process.env.REACT_APP_GITHUB_URL} className="text-gray-500 hover:text-gray-900 --dark:hover:text-white ms-5">
