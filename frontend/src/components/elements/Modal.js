...
const primaryBgColor =        {"danger": "bg-red-600",    "warning": "bg-orange-600",     "info": "bg-primary",        "success": "bg-green-500"}
const primaryBgLightColor =   {"danger": "bg-red-500",    "warning": "bg-orange-500",     "info": "bg-primary-light",  "success": "bg-green-400"}
...
export default function Modal({ show, onClose, title, buttons, style = "info", icon, loading, children }) {
          ...
          >
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className={`mx-auto flex size-12 shrink-0 items-center justify-center rounded-full ${primaryBgSubtleColor[style]} sm:mx-0 sm:size-10`}>
