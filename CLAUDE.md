...
- **No em-dashes (`—`) or en-dashes (`–`), ever** - not in copy, comments, docs, or anywhere else. Use a comma, a period, or a plain `-`. Also no "no X, no Y, no Z" triplets or similar LLM-tell phrasing ("seamless", "effortless", "whether you're...") in user-facing text. Write like a human.
