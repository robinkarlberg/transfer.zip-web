  ...
  tiers: [
    ...
    },
    {
      ...
      features: [
        ...
        "Priority support",
        // isInEU() ? "Proudly hosted in the EU 🇪🇺" : "Track views and downloads",
        <span><b>Custom</b> branding<span className="ms-1.5 px-1.5 py-0.5 text-xs font-semibold text-white bg-primary rounded-full">Coming Soon</span></span>,
        <span><b>Custom</b> domain<span className="ms-1.5 px-1.5 py-0.5 text-xs font-semibold text-white bg-primary rounded-full">Coming Soon</span></span>,
