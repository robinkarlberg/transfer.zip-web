...
<TLDR>
Email caps attachments at 20-25 MB. For larger files, share a link instead: use **Google Drive** (if you have one), **WeTransfer** (up to 3 GB free), or **Transfer.zip** (unlimited P2P, no upload wait, end-to-end encrypted). Compression rarely helps with already-compressed files like videos, JPEGs, and PDFs.
</TLDR>
