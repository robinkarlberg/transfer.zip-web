        ...
        <div className="PrivacyPolicyPage px-3 px-md-4">
            ...
            <div className="m-auto mt-4" style={{ maxWidth: "1100px" }}>
                ...
                <div className="" style={{ maxWidth: "700px" }}>
                    ...
                    <p>If using an account, we store your data until you request its removal. You can request data deletion by sending an email to contact@transfer.zip or by deleting your account via the account page.</p>
                    ...
                    <p>You have the right to access, modify, or delete your data. To exercise these rights, you can delete your account via the account page or send a request to contact@transfer.zip for data deletion and related inquiries.</p>
                    ...
                    <p>For any questions or concerns about this privacy policy or our data practices, please contact us at contact@transfer.zip.</p>
