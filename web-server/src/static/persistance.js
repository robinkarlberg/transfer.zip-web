...
const saveContactList = () => {
    window.localStorage.setItem(JSON.stringify(contactList))
}

const createContact = (localSessionId, remoteSessionId, key) => {
    contactList.push({ name: "Mobilen", localSessionId, remoteSessionId, key })
    saveContactList()
}
