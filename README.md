...
## Self-Hosting
To setup self-hosting, change the line `REACT_APP_SELFHOST=false` to `true`, in the `web-server/.env` file. This will enable only the core features for Quick Share to function.
