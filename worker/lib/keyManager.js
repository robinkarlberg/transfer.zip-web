...
export async function getPrivateKey() {
  const privateKeyPath = process.env.NODE_ENV == "development" ? "../_local_dev_worker_data/private.pem" : "/worker_data/private.pem"
...
export async function getPublicKey() {
  const publicKeyPath = process.env.NODE_ENV == "development" ? "../_local_dev_worker_data/public.pem" : "/worker_data/public.pem"
  if (cached.publicKey) {
